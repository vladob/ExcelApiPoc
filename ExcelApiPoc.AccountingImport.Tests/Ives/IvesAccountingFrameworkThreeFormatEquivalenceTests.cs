...
public sealed class IvesAccountingFrameworkThreeFormatEquivalenceTests
{
    private readonly ITestOutputHelper output;

    public IvesAccountingFrameworkThreeFormatEquivalenceTests(
    ...
    [Fact]
    public void Real_xml_xlsx_and_csv_are_semantically_equivalent()
    {
        ...
        {
            output.WriteLine(
                "All three IVES accounting-framework real-file " +
        ...
        output.WriteLine(
            "IVES AF three-format equivalence comparison completed.");
        output.WriteLine(
