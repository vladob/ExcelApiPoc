...
public sealed class IvesCsvGeneralLedgerRealFileDiagnosticTests
{
    private readonly ITestOutputHelper output;

    public IvesCsvGeneralLedgerRealFileDiagnosticTests(
    ...
    [Fact]
    public void Parse_real_csv_from_environment_variable()
    {
        const string variable = "IVES_GENERAL_LEDGER_CSV_TEST_FILE";
        ...
        Assert.Equal("01/9", firstDocument.Text);
        ...
        output.WriteLine("IVES CSV general-ledger diagnostic verified.");
        output.WriteLine("Physical rows       : " + result.SourceRowCount);
