...
namespace ExcelApiPoc.AddIn.Forms
{
    internal sealed class CreateAuditWorkbookForm : Form
    {
        ...
        public CreateAuditWorkbookForm()
        {
            ...
            journalBrowseButton.Click +=
                JournalBrowseButton_Click;
            ...
            accountsBrowseButton.Click +=
                AccountsBrowseButton_Click;
            ...
            _technicalTypeComboBox.SetBounds(
                165,
                122,
                200,
                25);

            _technicalTypeComboBox.Items.AddRange(
                new object[]
                {
                    "Unknown",
                    "CSV",
            ...
            _accountingFormatComboBox.SetBounds(
                165,
                162,
                200,
                25);
        ...
        private void SelectTechnicalType(string path)
        {
            ...
            _technicalTypeComboBox.SelectedItem =
                technicalType;
        }
        ...
        private void ContinueButton_Click(object sender,EventArgs e)
        {
            ...
            string accountsPath =
                _accountsPathTextBox.Text.Trim();

            if (!string.IsNullOrWhiteSpace(accountsPath) &&
                !File.Exists(accountsPath))
            {
                MessageBox.Show(
        ...
        private void DetectJournalInformation(string filePath)
        {
            ...
            _accountingFormatComboBox.SelectedItem =
                "Unknown";

            _icoTextBox.Clear();
            _fiscalYearTextBox.Clear();

            if (!IfoSoftCsvJournalDetector.TryDetect(
                    filePath,
            ...
            {
                _fiscalYearTextBox.Text =
                    detection.FiscalYear.Value.ToString(
