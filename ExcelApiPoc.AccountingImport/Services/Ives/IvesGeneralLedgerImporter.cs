...
{
    public sealed class IvesGeneralLedgerImporter : IGeneralLedgerImporter
    {
        public bool CanImport(string filePath, string accountingFormat)
        {
            return string.Equals(
                   ...
                   Path.GetFileName(filePath).StartsWith(
                       "HL_KNIHA_",
                       StringComparison.OrdinalIgnoreCase) &&
                   IvesGeneralLedgerParserDispatcher.CanParse(filePath);
        }

        public GeneralLedgerImport Import(string filePath)
        {
            IIvesGeneralLedgerSourceParser parser =
                IvesGeneralLedgerParserDispatcher.Select(filePath);
