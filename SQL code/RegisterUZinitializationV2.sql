/*
    RegisterUZinitializationV2.sql

    Version 2 SQL Server database structure for data retrieved from the
...
BEGIN
    ...
    (
        ...
        CONSTRAINT [FK_Registry_AccountingEntity_RegisteredOffice]
            FOREIGN KEY ([RegisteredOfficeCode]) REFERENCES [Reference].[Location] ([SourceCode]),
...
PRINT N'RegisterUZ database initialization V2 completed successfully.';
GO
